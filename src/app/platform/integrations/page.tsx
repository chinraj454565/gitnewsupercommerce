      ...
      <div className="pt-12 md:pt-20 pb-16 md:pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-700 max-w-3xl mb-6 md:mb-8 leading-relaxed">
            Browse and explore below Super Commerce integrations in multiple
            categories. Contact us to discuss custom integrations or integrating
            your solution with SuperSuper.
          </p>
      ...
      <div className=" py-12 md:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-4xl mx-auto text-center mb-8 md:mb-12 leading-relaxed px-4">
            Super Commerce together with Segment.com allow you to collect and
            unify user-centric data and easily leverage over 200 marketing
            automation, referral, email, A/B testing, live chat, advanced
