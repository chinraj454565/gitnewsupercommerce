      ...
      <div className="bg-[#F7F7F6] pt-20 pb-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-[56px] font-normal text-gray-900 mb-4 leading-tight">
            Super Commerce open-source eCommerce features
          </h1>

          <p className="text-base md:text-lg text-gray-700 mb-10 max-w-2xl mx-auto">
            Own your tech stack. Build exactly what you want. Get full control
            and customizability.
          </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-base text-gray-700 leading-relaxed">
                  Easily customize your homepage, product listings and product
                  detail pages. Use the default storefront or connect your own
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-base text-gray-700 leading-relaxed">
                  Enable your multiple brands, customer's or reseller's to run
                  separate stores with centralized or separate product catalogs.
                  Manage all stores from your admin panel.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 border border-gray-200">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  Sell in multiple regions or countries, in any language, any
                  currency, any payment method or shipping provider. Manage all
                  shopping experiences in one admin panel.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 border border-gray-200">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  Manage unlimited products and variants individually or in
                  bulk. Categorize, label, add custom attributes. Export, edit
                  in a spreadsheet, import back again.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-base text-gray-700 leading-relaxed">
                  Manage stock levels across sales channels and locations. Track
                  stock movements, receive stock, make transfers. Make products
                  available or discontinued on a given date.
                </p>
              </div>
              <div className="bg-gradient-to-br from-gray-100 to-gray-50 rounded-2xl p-6 border border-gray-200">
                <img
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 border border-gray-200">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  Generate gift cards or discounts with a robust promo rule
                  engine for giving customers or some products available under
                  particular circumstances eg. first purchase.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 border border-gray-200">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  Manage shipping across regions and warehouses. Use any
                  shipping provider or aggregator. Track shipments in real time
                  with email notifications for customers.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-base text-gray-700 leading-relaxed">
                  Customize checkout to reflect your business logic. Style it to
                  be on-brand. Manage shipping and taxes calculations. Enable
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-base text-gray-700 leading-relaxed">
                  Manage orders via admin dashboard or rely on automated order
                  processing. Use order splitting by vendor in a dropshipping
                  model. Support partial or full returns and exchanges.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 border border-gray-200">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  Digital Products are created in the same way as Physical
                  Products, except they require a file to be attached to its
                  variant (or variants, e.g., different language versions).
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 border border-gray-200">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  Super Commerce follows industry-standard security practices in
                  handling credit card data. It also relies on payment gateways
                  for PCI compliance.
                </p>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-base text-gray-700 leading-relaxed">
                  Make your website compliant with WCAG by setting the right
                  order of focus throughout the site, correct HTML syntax,
                  sufficient contrast, and proper handling of pop-ups.
                </p>
              </div>
              <div className="bg-gradient-to-br from-gray-100 to-gray-50 rounded-2xl p-6 border border-gray-200">
                <img
