    ...
    <section className="w-full bg-white py-32">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
          Spree 5: The Biggest Release Ever
        </h2>

        {/* Content */}
        <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed">
          From no-code tools to enterprise-grade integrations — Spree 5 has
        ...
        <div className="flex justify-center gap-5 mb-20 flex-wrap">
          ...
          <Link
            href="/demo"
            className="px-7 py-3 rounded-lg bg-gray-100 text-gray-900 font-semibold hover:bg-gray-200 transition"
          >
            See demo
          </Link>
        </div>

        {/* Feature Cards – Spree Style */}
