        ...
        <div className="flex flex-col lg:flex-row relative">
          ...
          <div className="w-full lg:w-[68%] z-10">
            ...
            <h1 className="text-[32px] md:text-[42px] lg:text-[54px] font-normal text-[#0a1a2f] leading-[1.15] mb-8 max-w-[820px]">
              Super Commerce is an open-source eCommerce framework giving you
            ...
            <div className="relative w-full overflow-hidden mt-4">
              ...
              <div
                ...
                style={{
                  background: "linear-gradient(to right, #F7F7F6, transparent)",
                }}
              />
              <div
                className="absolute right-0 top-0 h-full w-24 z-10 pointer-events-none"
                style={{
                  background: "linear-gradient(to left, #F7F7F6, transparent)",
                }}
              />
